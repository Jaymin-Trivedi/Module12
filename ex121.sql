...
ALTER DATABASE [InternetSales] ADD FILE ( NAME = N'Memory_optimize_filegroup', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Memory_optimize_filegroup' ) TO FILEGROUP [Memory_optimize_filegroup]
GO
